...
const BentoView = () => {
  ...
  const renderBentoItem = (key, value, depth = 0) => {
    ...
    const itemStyle = `p-6 bg-gradient-to-br from-gray-900 to-gray-800 backdrop-blur-lg transition-all duration-300 hover:shadow-xl hover:scale-105 border border-gray-700`;
